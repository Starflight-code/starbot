...
public class Watcher {
    ...
    public async void RegisterCommand(DiscordSocketClient client, ulong guildID, Database data, SlashCommandProperties? slashData) {
        if (commandNamesMissing.Contains(slashData.Name.Value)) { // TODO: Fix invalid logic here, should check for matching names, instead of an array of IDs
    ...
    public async void RegisterCommand(DiscordSocketClient client, ulong guildID, Database data, MessageCommandProperties? messageData) {
        if (commandNamesMissing.Contains(messageData.Name.Value)) { // TODO: Fix invalid logic here, should check for matching names, instead of an array of IDs
