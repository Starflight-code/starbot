...
class Recovery {
    public static bool attemptRecovery(List<SocketGuild> guildsAffected, scheduledTask lambda, Discord.WebSocket.DiscordSocketClient client, StarBot.Database data, StarBot.Caching.MemoryCacheManager cache, DebugComms debug) {
